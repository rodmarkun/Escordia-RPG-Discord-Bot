...
weapon_staff = inventory.Equipment('Staff', '', 1, 50, 'Weapon', {'atk' : 2, 'matk' : 3, 'maxMp' : 4})
    ...
    # Shop Area 2
weapon_huntingBow = inventory.Equipment('Hunting Bow', '', 1, 110, 'Weapon', {'atk' : 5, 'critCh' : 35, 'speed' : -6})
weapon_battleAxe = inventory.Equipment('Battle Axe', '', 1, 120, 'Weapon', {'atk' : 8, 'def' : 2, 'speed' : -1})
weapon_scimitar = inventory.Equipment('Scimitar', '', 1, 120, 'Weapon', {'atk' : 7, 'critCh' : 5, 'speed' : 3})
weapon_priestStaff = inventory.Equipment('Staff', '', 1, 110, 'Weapon', {'atk' : 4, 'matk' : 5, 'maxMp' : 5})

    # Dungeon 02 Area 2
weapon_boneDagger = inventory.Equipment('Bone Dagger', '', 1, 200, 'Weapon', {'atk' : 8, 'critCh' : 15, 'speed' : 5})
weapon_necromancerStaff = inventory.Equipment('Necromancer Staff', '', 1, 200, 'Weapon', {'atk' : 5, 'matk' : 8, 'maxMp' : 7})
weapon_ancientWarhammer = inventory.Equipment('Ancient Warhammer', '', 1, 220, 'Weapon', {'atk' : 12, 'def' : 4, 'speed' : -5, 'critCh' : -10})
weapon_skeletonAxe = inventory.Equipment('Skeleton Axe', '', 1, 200, 'Weapon', {'atk' : 10, 'def' : 3, 'speed' : -3})
weapon_lichScythe = inventory.Equipment('Lich Scythe', '', 1, 250, 'Weapon', {'atk' : 9, 'matk' : 6, 'critCh' : 5})
...
acc_shapphireRing = inventory.Equipment('Shapphire Ring', '', 1, 150, 'Accesory', {'maxMp' : 10})
    ...
    # Dungeon 02 Area 2
acc_necromancerRing = inventory.Equipment('Necromancer Ring', '', 1, 250, 'Accesory', {'maxHp' : -2 ,'matk' : 4, 'maxMp' : 3})
acc_thiefBandana = inventory.Equipment('Thief Bandana', '', 1, 220, 'Accesory', {'speed' : 3, 'critCh' : 4})
